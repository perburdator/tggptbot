...
class GPT:
    def __init__(self, system_content="Ты -помощник для решения различных задач. Отвечай кратко и только на русском языке."):
        self.system_content = system_content
        self.URL = 'http://localhost:1234/v1/chat/completions'
        self.HEADERS = {"Content-Type": "application/json"}
        self.MAX_TOKENS = 2048
        self.assistant_content = "Мой краткий ответ: "
